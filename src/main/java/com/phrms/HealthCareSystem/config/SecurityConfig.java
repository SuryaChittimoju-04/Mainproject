...
import com.phrms.HealthCareSystem.service.token.TokenVerificationService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.addFilterBefore(tokenVerificationService, UsernamePasswordAuthenticationFilter.class);
